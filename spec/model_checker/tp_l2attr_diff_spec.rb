...
describe 'termination point diff with L2 attribute', :diff, :tp, :attr, :l2attr do
  before do
    ...
    tp_l2attr0_def = NWTopoDSL::TermPoint.new('tpX', l2nw_type)
    tp_l2attr_def = NWTopoDSL::TermPoint.new('tpX', l2nw_type) do
      attribute(access_vlan_a)
    end
    tp_l2attr_added_def = NWTopoDSL::TermPoint.new('tpX', l2nw_type) do
      attribute(access_vlan_a_added)
    end
    tp_l2attr_deleted_def = NWTopoDSL::TermPoint.new('tpX', l2nw_type) do
      attribute(access_vlan_a_deleted)
    end
    tp_l2attr_changed_def = NWTopoDSL::TermPoint.new('tpX', l2nw_type) do
      attribute(access_vlan_a_changed)
    end

    @tp_l2attr0 = TopoChecker::TerminationPoint.new(tp_l2attr0_def.topo_data, '')
    @tp_l2attr = TopoChecker::TerminationPoint.new(tp_l2attr_def.topo_data, '')
    @tp_l2attr_added = TopoChecker::TerminationPoint.new(tp_l2attr_added_def.topo_data, '')
    @tp_l2attr_deleted = TopoChecker::TerminationPoint.new(tp_l2attr_deleted_def.topo_data, '')
    @tp_l2attr_changed = TopoChecker::TerminationPoint.new(tp_l2attr_changed_def.topo_data, '')
  end
