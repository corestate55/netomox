...
describe 'termination point diff with L3 attribute', :diff, :tp, :attr, :l3attr do
  before do
    ...
    tp_l3attr0_def = NWTopoDSL::TermPoint.new('tpX', l3nw_type)
    tp_l3attr_def = NWTopoDSL::TermPoint.new('tpX', l3nw_type) do
      attribute(tp_attr)
    end
    tp_l3attr_added_def = NWTopoDSL::TermPoint.new('tpX', l3nw_type) do
      attribute(tp_attr_added)
    end
    tp_l3attr_deleted_def = NWTopoDSL::TermPoint.new('tpX', l3nw_type) do
      attribute(tp_attr_deleted)
    end
    tp_l3attr_changed_def = NWTopoDSL::TermPoint.new('tpX', l3nw_type) do
      attribute(tp_attr_changed)
    end

    @tp_l3attr0 = TopoChecker::TerminationPoint.new(tp_l3attr0_def.topo_data, '')
    @tp_l3attr = TopoChecker::TerminationPoint.new(tp_l3attr_def.topo_data, '')
    @tp_l3attr_added = TopoChecker::TerminationPoint.new(tp_l3attr_added_def.topo_data, '')
    @tp_l3attr_deleted = TopoChecker::TerminationPoint.new(tp_l3attr_deleted_def.topo_data, '')
    @tp_l3attr_changed = TopoChecker::TerminationPoint.new(tp_l3attr_changed_def.topo_data, '')
  end
